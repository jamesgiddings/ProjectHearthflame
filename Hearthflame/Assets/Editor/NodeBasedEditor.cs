...
public class NodeBasedEditor : EditorWindow
{
    ...
    private void ProcessContextMenu(Vector2 mousePosition)
    {
        ...
        genericMenu.AddItem(new GUIContent("Add different kind of node"), false, () => OnClickAddDifferentNode(mousePosition));
    ...
    private void OnClickAddDifferentNode(Vector2 mousePosition)
    {
        if (nodes == null)
        {
            nodes = new List<Node>();
        ...
        nodes.Add(new Node(mousePosition, 100, 25, nodeStyle, selectedNodeStyle, inPointStyle, outPointStyle, OnClickInPoint, OnClickOutPoint, OnClickRemoveNode));
    }
